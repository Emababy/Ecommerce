                                ...
                                <div class="px-2 pt-2 pb-2 bg-white rounded-md shadow-lg dark-mode:bg-gray-700 max-w-xs"> 
                                    <div class="grid gap-2 items-center">
                                        <?php
                                            ...
                                            <a href="Items.php?PageID=<?php echo $item['Item_ID']; ?>" class="flex items-center rounded-lg bg-transparent p-2 duration-300 transition-ease hover:text-indigo-400">
